...
export class GeocodingService {
  ...
  async search(query: string): Promise<GeocodeResult[]> {
    const LOCAL_HOTSPOTS = [
      { nom: 'Ndokotti', adresse: 'Carrefour Ndokotti, Douala, Cameroun', latitude: 4.0511, longitude: 9.7679 },
      { nom: 'Akwa', adresse: 'Akwa, Douala, Cameroun', latitude: 4.0503, longitude: 9.7082 },
      { nom: 'Bonanjo', adresse: 'Bonanjo, Douala, Cameroun', latitude: 4.0435, longitude: 9.6849 },
      { nom: 'Deido', adresse: 'Rond-point Deido, Douala, Cameroun', latitude: 4.0638, longitude: 9.7075 },
      { nom: 'Bonapriso', adresse: 'Bonapriso, Douala, Cameroun', latitude: 4.0298, longitude: 9.7042 },
      { nom: 'Bastos', adresse: 'Bastos, Yaoundé, Cameroun', latitude: 3.8902, longitude: 11.5122 },
      { nom: 'Mvan', adresse: 'Gare routière Mvan, Yaoundé, Cameroun', latitude: 3.8242, longitude: 11.5204 },
      { nom: 'Poste Centrale', adresse: 'Poste Centrale, Yaoundé, Cameroun', latitude: 3.8642, longitude: 11.5201 },
      { nom: 'Aéroport International de Douala', adresse: 'Aéroport de Douala, Cameroun', latitude: 4.0158, longitude: 9.7194 },
      { nom: 'Université de Douala', adresse: 'Esplanade Université de Douala, Cameroun', latitude: 4.0612, longitude: 9.7285 },
      { nom: 'Hôpital Général de Douala', adresse: 'Hôpital Général, Douala, Cameroun', latitude: 4.0616, longitude: 9.7571 },
      { nom: 'Logbessou', adresse: 'Logbessou, Douala, Cameroun', latitude: 4.0853, longitude: 9.7891 },
      { nom: 'Bonamoussadi', adresse: 'Bonamoussadi, Douala, Cameroun', latitude: 4.0811, longitude: 9.7425 },
      { nom: 'Kribi', adresse: 'Kribi, Cameroun', latitude: 2.9377, longitude: 9.9077 },
      { nom: 'Limbe', adresse: 'Limbe, Cameroun', latitude: 4.0125, longitude: 9.2205 },
    ];
